...
export function HelpDialog({ openDialog, onClose }) {
    ...
    return <Dialog open={openDialog} onClose={onClose}>
        ...
        <DialogContent>
            ...
            <DialogContentText>
                This website uses cookies to gather anonymous usage data and manage logins where necessary. No data is shared with 3rd parties. This tool is provided "as is" with no warranty. By clicking 'I AGREE' below you agree to the use of cookies as described.
            </DialogContentText>
        </DialogContent>
        <DialogActions>
